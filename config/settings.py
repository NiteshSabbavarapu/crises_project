...
DEFAULT_FROM_EMAIL = os.getenv("DEFAULT_FROM_EMAIL") or EMAIL_HOST_USER or "alerts@crisissync.local"
...
GLOBAL_NEWS_WINDOW_HOURS = int(os.getenv("GLOBAL_NEWS_WINDOW_HOURS", "12"))
